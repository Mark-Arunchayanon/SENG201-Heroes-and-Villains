 ...
 * @author par116
 */
public class DiceRoll extends VillainGame {
	...
	public boolean play(String villain_name, Hero playing_hero) {
		...
		while(player_score < 2 && villain_score < 2) {
			...
			hero_roll = r.nextInt(6);
			villain_roll = r.nextInt(6);
			
			// Sets a message to labels on what the hero and villain rolled
			lab2 = playing_hero.getName() + " rolled a " + options[hero_roll] + " and " +
			villain_name + " rolled a " + options[villain_roll] + ".";
			...
			lab4 = "Current scores are: " + playing_hero.getName() +
					": " + player_score + ",  " + villain_name + ": " + villain_score;
